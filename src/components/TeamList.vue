    ...
    >
      <template #tags>
        ...
        <div style="padding-top: 3px">
          ...
          <span>
            &nbsp;--&nbsp; 剩余位置：{{
              team.maxNum - team.userSet.length <= 0 ? "已满员" : team.maxNum - team.userSet.length + " 人"
            }}
        </span>
        </div>
        <div style="padding-top: 3px">
      ...
      <template #footer>
        ...
        <span v-if="!isUserInTeam(team)">
          <van-button v-if="team.maxNum - team.userSet.length <= 0" plain size="mini" type="primary" icon="hot-o"
                      disabled> 已满员 </van-button>
